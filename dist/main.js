!(function (e) {
  ...
  function (e, t, n) {
    ...
    o.push([
      e.i,
      '.App-module__header__3fyn7{font-size:64px}',
      '',
      {
        version: 3,
        sources: ['webpack://src/App.module.scss'],
        names: [],
        mappings: 'AAAA,2BACE,cAAA',
        sourcesContent: ['.header {\r\n  font-size: 64px;\r\n}\r\n'],
        sourceRoot: '',
      },
    ]),
      (o.locals = { header: 'App-module__header__3fyn7' }),
      (t.a = o);
  },
  function (e, t, n) {
    'use strict';
    ...
    o.push([
      ...
      '',
      {
        ...
        names: [],
        mappings: 'AAAA;IACI,iBAAiB;IACjB,6DAA6D;AACjE',
        sourcesContent: [
          'body {\r\n    min-height: 100vh;\r\n    background: linear-gradient(180deg, #f5db13 0%, #f2b807 100%);\r\n}',
        ],
        sourceRoot: '',
...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (e, t, n) {
    ...
    var l = r(n(3)),
      a = r(n(9)),
      o = r(n(13));
    n(16), a.default.render(l.default.createElement(o.default), document.getElementById('root'));
  },
  function (e, t, n) {
    'use strict';
  ...
  function (e, t, n) {
        ...
        e: {
          ...
          if (void 0 !== u) {
            ...
            for (var p, h = r; null !== h; ) {
              var m = (p = h).stateNode;
              if (
                (5 === p.tag && null !== m && ((p = m), null !== d && null != (m = Ue(h, d)) && s.push(zr(h, m, p))), f)
              )
                break;
              h = h.return;
            }
    ...
    function ci(e, t) {
      ...
      if (((r = Ft(e, e === Cu ? Nu : 0)), (t = It), 0 === r))
        ...
        15 === t
          ? ((n = di.bind(null, e)), null === Rl ? ((Rl = [n]), (Il = kl(Pl, Wl))) : Rl.push(n), (n = Ol))
          : 14 === t
    ...
    function si(e) {
      ...
      if ((Gl(), (Eu.current = a), (_u = l), null !== Pu ? (r = 0) : ((Cu = null), (Nu = 0), (r = zu)), 0 != (Mu & Iu)))
        gi(e, 0);
      else if (0 !== r) {
        if (
          (2 === r &&
    ...
    function gi(e, t) {
      ...
      (Cu = e), (Pu = Ui(e.current, null)), (Nu = Tu = Mu = t), (zu = 0), (Ou = null), (Du = Iu = Ru = 0);
    }
    function yi(e, t) {
      for (;;) {
        var n = Pu;
    ...
    function Ci(e, t) {
      ...
      if ((ci(e, Al()), $u)) throw (($u = !1), (e = Wu), (Wu = null), e);
    ...
    function Ri(e, t, n) {
      ...
      null !== r && r.delete(t),
        ...
        Cu === e &&
          (Nu & n) === n &&
          (4 === zu || (3 === zu && (62914560 & Nu) === Nu && 500 > Al() - Au) ? gi(e, 0) : (Du |= n)),
        ci(e, t);
    }
    function Ii(e, t) {
      var n = e.stateNode;
    ...
    var tc = { Events: [Jr, Zr, el, Le, ze, Ni, { current: !1 }] },
      ...
      try {
        for (I(n), L = x(P); null !== L && (!(L.expirationTime > n) || (e && !t.unstable_shouldYield())); ) {
          ...
          if ('function' == typeof o) {
            ...
            (n = t.unstable_now()), 'function' == typeof u ? (L.callback = u) : L === x(P) && _(P), I(n);
          } else _(P);
          L = x(P);
        }
        if (null !== L) var i = !0;
    ...
    t.default = function () {
      return (
        ...
        l.default.createElement(
          'div',
          { className: a.default(o.default.header, 'color') },
          "'Sup! This is App Component!",
        )
      );
    };
  },
